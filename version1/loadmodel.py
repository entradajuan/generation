...
checkpoint_dir = './training_checkpoints/2021-Sep-01-09-22-12/' 
...
def generate_text(model, start_string, temperature=0.2, num_generate=99):
...
print(generate_text(gen_model, start_string=u"Sevilla"))
